...
{
header("Location:../ifaces/edition_typologies.php?err=Une convention porte deja le meme nom!&nom=".$_POST['nom']."&description=".$_POST['description']."&couleur=".substr($_POST['couleur'],1));
$req->closeCursor(); // Termine le traitement de la requête
}
...
header('Location:../ifaces/edition_typologies.php?msg=Convention enregistrée avec succes!');
 }
