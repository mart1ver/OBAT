...
<div class="panel panel-default">
  <div class="panel-body">
        <label for="qualite">Qualité:</label> <b><font size="4">5</font></b><input  type="range"  style="width: 200px; display:inline;"  name="qualite" id="qualite" min="0" max="5" ><label for="bat">commentaire:&nbsp</label><input type="text"  ><br>
 </div>
</div>
</div>
</div>
