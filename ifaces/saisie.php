...
<div class="panel panel-default">
  <div class="panel-body">
        <label for="qualite">Qualité:</label> <b><font name="label_qualite" id="label_qualite" size="4">0</font><font size="4">/5</font></b><input  type="range"  style="width: 200px;"  name="qualite" id="qualite" value="0" min="0" max="5" onchange="updatenote_qualite(this.value)"><br><b>commentaire:&nbsp</b><input  type="text"  ><br>
 </div>
</div>
</div>
</div>
