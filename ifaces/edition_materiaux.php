...
?>
    ...
    <div class="container">
      ...
      <div class="panel-body">
        <div class="row">
          <form action="../moteur/edition_materiaux_post.php" method="post">
...
<td>
<form action="../moteur/materiau_visible.php" method="post">
...
<form action="modification_materiau.php" method="post">
