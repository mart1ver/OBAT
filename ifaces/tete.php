...
// Afficher l'erreur si elle existe
                                    if (isset($_GET['err']))
                                        echo "<br><div class='alert alert-danger' style='width:80%;margin:auto;'>$_GET[err]</div>";

// Affiche le message s'il existe
                                    if (isset($_GET['msg']))
                                        echo "<br><div class='alert alert-success alert-dismissable' style='width:80%;margin:auto;'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>$_GET[msg]</div>";
                                    ?>
