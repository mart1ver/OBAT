...
?>
  ...
  <div class="row"><label for="note1">Coef. qualité:</label> <input name="note1" id="note1" type="number" value ="" required autofocus></div>
  <div class="row"><label for="note2">Coef. risque de dépose:</label> <input name="note2" id="note2" type="number" value ="" required ></div>
  <div class="row"><label for="note3">Coef. complexité de traitement:</label> <input name="note3" id="note3" type="number" value ="" required ></div>
  <div class="row"><label for="note4">Coef. complexité conditionnement et stockage:</label> <input name="note4" id="note4" type="number" value ="" required ></div> 
  <br>
