...
?>
    ...
    <div class="container">
        <h1>Gestion de la liste des corps d'état</h1> 
         <div class="panel-heading">Gérez ici votre liste des corps d'état.</div>
         <p>Permet de différencier les materiaux et materiels au moment des recherches </p>
      <div class="panel-body">
        <div class="row">
          <form action="../moteur/modification_corps_post.php" method="post">
