                            ...
                            <div class="col-md-5">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <input type="checkbox" name="destination1" value="1" disabled <?php if (intval($isreempl) === 1) {
                                echo(" checked");
                            }; ?> ><label for="destination1">Réemploi,</label><br>
                                        <input type="checkbox" name="destination2" value="1" disabled <?php if (intval($isreutil) === 1) {
                                echo(" checked");
                            }; ?> ><label for="destination2">Réutilisation,</label><br>
                                        <input type="checkbox" name="destination3" value="1" disabled <?php if (intval($isrecy) === 1) {
                                echo(" checked");
