...
<div class="container">
    <h1>Gestion de la liste des materiaux</h1> 
    <div class="panel-heading">Gérez ici votre liste de materiaux ré-employables.</div>
    <p>Permet de différencier les materiaux au moment des recherches </p>
    <div class="panel-body">
        <div class="row">
            <form action="../moteur/modification_materiaux_post.php" method="post">
                    ...
                    <div class="col-md-7">
                        ...
                        <select class="chzn-select" name="corp" id="corp">
                            ...
                            while ($donnees = $req->fetch()) {
                                ...
                                <option value="<?php echo($donnees['id']); ?> <?php if ($donnees['id'] == $_POST["id_corp"]) {
                        ...
                        <select  class="chzn-select" name="typologie" id="typologie">
                            ...
                            while ($donnees = $req->fetch()) {
                                ...
                                <option value="<?php echo($donnees['id']); ?>" <?php if ($donnees['id'] == $_POST["id_typologie"]) {
                                    echo'selected="selected"';
                                } ?>><?php echo($donnees['nom']); ?></option>
